...
const SEED_LETTERS = [
  {
    ...
    body: [
      ...
      'Bazen "Herkes herkesten vazgeçebilir." diyorsun. Bu cümleyi her duyduğumda içimde bir boşluk oluşuyor. Çünkü ben ilişkilere hiçbir zaman böyle bakmadım.',
      "Benim için bir ilişki, denemek için girilen bir yol değil. Ben bir yola çıkacaksam, o yolu gerçekten yürümek için çıkarım. Daha en başından dönüş ihtimalini düşünerek adım atmam. Elbette hayatın ne getireceğini kimse bilemez ama ben sevgiyi, sürekli vazgeçme ihtimalini konuşarak büyütmenin doğru olduğuna inanmıyorum.",
